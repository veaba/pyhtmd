...
# <p><a href="https://tensorflow.google.cn/api_docs/python/tf/audio"><code translate="no" dir="ltr">audio</code></a> module: Public API for tf.audio namespace.</p>
# """
# <devsite-code><pre class="lang-py" translate="no" dir="ltr" is-upgraded=""><code class="devsite-terminal" data-terminal-prefix=">>>" dir="ltr"><span class="pln">x </span><span class="pun">=</span><span class="pln"> tf</span><span class="pun">.</span><span class="pln">constant</span><span class="pun">([</span><span class="lit">1</span><span class="pun">,</span><span class="pln"> </span><span class="lit">2</span><span class="pun">,</span><span class="pln"> </span><span class="lit">3</span><span class="pun">])</span></code><span class="pln"><br></span><code class="devsite-terminal" data-terminal-prefix=">>>" dir="ltr"><span class="pln">y </span><span class="pun">=</span><span class="pln"> tf</span><span class="pun">.</span><span class="pln">broadcast_to</span><span class="pun">(</span><span class="pln">x</span><span class="pun">,</span><span class="pln"> </span><span class="pun">[</span><span class="lit">3</span><span class="pun">,</span><span class="pln"> </span><span class="lit">3</span><span class="pun">])</span></code><span class="pln"><br></span><code class="devsite-terminal" data-terminal-prefix=">>>" dir="ltr"><span class="pln">sess</span><span class="pun">.</span><span class="pln">run</span><span class="pun">(</span><span class="pln">y</span><span class="pun">)</span></code><span class="pln"><br></span><code class="no-select nocode" dir="ltr">array([[1, 2, 3],</code><span class="pln"><br></span><code class="no-select nocode" dir="ltr">       [1, 2, 3],</code><span class="pln"><br></span><code class="no-select nocode" dir="ltr">       [1, 2, 3]], dtype=int32)</code><span class="pln"><br></span></pre><div class="devsite-code-buttons-container"><button class="gc-analytics-event material-icons devsite-icon-code-dark devsite-toggle-dark" data-category="Site-Wide Custom Events" data-label="Dark Code Toggle" track-type="exampleCode" track-name="darkCodeToggle" data-title="Dark code theme"></button><button class="gc-analytics-event material-icons devsite-icon-code-light devsite-toggle-light" data-category="Site-Wide Custom Events" data-label="Light Code Toggle" track-type="exampleCode" track-name="lightCodeToggle" data-title="Light code theme"></button><button class="gc-analytics-event material-icons devsite-icon-copy" data-category="Site-Wide Custom Events" data-label="Click To Copy" track-type="exampleCode" track-name="clickToCopy" data-title="Copy"></button></div></devsite-code>

item = """
<blockquote>
<devsite-code><pre class="" translate="no" dir="ltr" is-upgraded=""><code dir="ltr"><span class="pln">x </span><span class="pun">=</span><span class="pln"> </span><span class="pun">[[[[</span><span class="lit">1</span><span class="pun">],</span><span class="pln"> &nbsp; </span><span class="pun">[</span><span class="lit">2</span><span class="pun">],</span><span class="pln"> &nbsp;</span><span class="pun">[</span><span class="lit">3</span><span class="pun">],</span><span class="pln"> &nbsp;</span><span class="pun">[</span><span class="lit">4</span><span class="pun">]],</span><span class="pln"><br>&nbsp; &nbsp; &nbsp; </span><span class="pun">[[</span><span class="lit">5</span><span class="pun">],</span><span class="pln"> &nbsp; </span><span class="pun">[</span><span class="lit">6</span><span class="pun">],</span><span class="pln"> &nbsp;</span><span class="pun">[</span><span class="lit">7</span><span class="pun">],</span><span class="pln"> &nbsp;</span><span class="pun">[</span><span class="lit">8</span><span class="pun">]]],</span><span class="pln"><br>&nbsp; &nbsp; &nbsp;</span><span class="pun">[[[</span><span class="lit">9</span><span class="pun">],</span><span class="pln"> &nbsp;</span><span class="pun">[</span><span class="lit">10</span><span class="pun">],</span><span class="pln"> </span><span class="pun">[</span><span class="lit">11</span><span class="pun">],</span><span class="pln"> &nbsp;</span><span class="pun">[</span><span class="lit">12</span><span class="pun">]],</span><span class="pln"><br>&nbsp; &nbsp; &nbsp; </span><span class="pun">[[</span><span class="lit">13</span><span class="pun">],</span><span class="pln"> </span><span class="pun">[</span><span class="lit">14</span><span class="pun">],</span><span class="pln"> </span><span class="pun">[</span><span class="lit">15</span><span class="pun">],</span><span class="pln"> &nbsp;</span><span class="pun">[</span><span class="lit">16</span><span class="pun">]]]]</span><span class="pln"><br></span></code></pre><div class="devsite-code-buttons-container"><button class="gc-analytics-event material-icons devsite-icon-code-dark devsite-toggle-dark" data-category="Site-Wide Custom Events" data-label="Dark Code Toggle" track-type="exampleCode" track-name="darkCodeToggle" data-title="Dark code theme"></button><button class="gc-analytics-event material-icons devsite-icon-code-light devsite-toggle-light" data-category="Site-Wide Custom Events" data-label="Light Code Toggle" track-type="exampleCode" track-name="lightCodeToggle" data-title="Light code theme"></button><button class="gc-analytics-event material-icons devsite-icon-copy" data-category="Site-Wide Custom Events" data-label="Click To Copy" track-type="exampleCode" track-name="clickToCopy" data-title="Copy"></button></div></devsite-code></blockquote>
"""
