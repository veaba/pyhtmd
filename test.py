...
item = """
<devsite-code><pre class="lang-python" translate="no" dir="ltr" is-upgraded=""><code dir="ltr"><span class="com"># 2-D tensor `a`</span><span class="pln"><br></span><span class="com"># [[1, 2, 3],</span><span class="pln"><br></span><span class="com"># &nbsp;[4, 5, 6]]</span><span class="pln"><br>a </span><span class="pun">=</span><span class="pln"> tf</span><span class="pun">.</span><span class="pln">constant</span><span class="pun">([</span><span class="lit">1</span><span class="pun">,</span><span class="pln"> </span><span class="lit">2</span><span class="pun">,</span><span class="pln"> </span><span class="lit">3</span><span class="pun">,</span><span class="pln"> </span><span class="lit">4</span><span class="pun">,</span><span class="pln"> </span><span class="lit">5</span><span class="pun">,</span><span class="pln"> </span><span class="lit">6</span><span class="pun">],</span><span class="pln"> shape</span><span class="pun">=[</span><span class="lit">2</span><span class="pun">,</span><span class="pln"> </span><span class="lit">3</span><span class="pun">])</span><span class="pln"><br><br></span><span class="com"># 2-D tensor `b`</span><span class="pln"><br></span><span class="com"># [[ 7, &nbsp;8],</span><span class="pln"><br></span><span class="com"># &nbsp;[ 9, 10],</span><span class="pln"><br></span><span class="com"># &nbsp;[11, 12]]</span><span class="pln"><br>b </span><span class="pun">=</span><span class="pln"> tf</span><span class="pun">.</span><span class="pln">constant</span><span class="pun">([</span><span class="lit">7</span><span class="pun">,</span><span class="pln"> </span><span class="lit">8</span><span class="pun">,</span><span class="pln"> </span><span class="lit">9</span><span class="pun">,</span><span class="pln"> </span><span class="lit">10</span><span class="pun">,</span><span class="pln"> </span><span class="lit">11</span><span class="pun">,</span><span class="pln"> </span><span class="lit">12</span><span class="pun">],</span><span class="pln"> shape</span><span class="pun">=[</span><span class="lit">3</span><span class="pun">,</span><span class="pln"> </span><span class="lit">2</span><span class="pun">])</span><span class="pln"><br><br></span><span class="com"># `a` * `b`</span><span class="pln"><br></span><span class="com"># [[ 58, &nbsp;64],</span><span class="pln"><br></span><span class="com"># &nbsp;[139, 154]]</span><span class="pln"><br>c </span><span class="pun">=</span><span class="pln"> tf</span><span class="pun">.</span><span class="pln">matmul</span><span class="pun">(</span><span class="pln">a</span><span class="pun">,</span><span class="pln"> b</span><span class="pun">)</span><span class="pln"><br><br><br></span><span class="com"># 3-D tensor `a`</span><span class="pln"><br></span><span class="com"># [[[ 1, &nbsp;2, &nbsp;3],</span><span class="pln"><br></span><span class="com"># &nbsp; [ 4, &nbsp;5, &nbsp;6]],</span><span class="pln"><br></span><span class="com"># &nbsp;[[ 7, &nbsp;8, &nbsp;9],</span><span class="pln"><br></span><span class="com"># &nbsp; [10, 11, 12]]]</span><span class="pln"><br>a </span><span class="pun">=</span><span class="pln"> tf</span><span class="pun">.</span><span class="pln">constant</span><span class="pun">(</span><span class="pln">np</span><span class="pun">.</span><span class="pln">arange</span><span class="pun">(</span><span class="lit">1</span><span class="pun">,</span><span class="pln"> </span><span class="lit">13</span><span class="pun">,</span><span class="pln"> dtype</span><span class="pun">=</span><span class="pln">np</span><span class="pun">.</span><span class="pln">int32</span><span class="pun">),</span><span class="pln"><br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; shape</span><span class="pun">=[</span><span class="lit">2</span><span class="pun">,</span><span class="pln"> </span><span class="lit">2</span><span class="pun">,</span><span class="pln"> </span><span class="lit">3</span><span class="pun">])</span><span class="pln"><br><br></span><span class="com"># 3-D tensor `b`</span><span class="pln"><br></span><span class="com"># [[[13, 14],</span><span class="pln"><br></span><span class="com"># &nbsp; [15, 16],</span><span class="pln"><br></span><span class="com"># &nbsp; [17, 18]],</span><span class="pln"><br></span><span class="com"># &nbsp;[[19, 20],</span><span class="pln"><br></span><span class="com"># &nbsp; [21, 22],</span><span class="pln"><br></span><span class="com"># &nbsp; [23, 24]]]</span><span class="pln"><br>b </span><span class="pun">=</span><span class="pln"> tf</span><span class="pun">.</span><span class="pln">constant</span><span class="pun">(</span><span class="pln">np</span><span class="pun">.</span><span class="pln">arange</span><span class="pun">(</span><span class="lit">13</span><span class="pun">,</span><span class="pln"> </span><span class="lit">25</span><span class="pun">,</span><span class="pln"> dtype</span><span class="pun">=</span><span class="pln">np</span><span class="pun">.</span><span class="pln">int32</span><span class="pun">),</span><span class="pln"><br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; shape</span><span class="pun">=[</span><span class="lit">2</span><span class="pun">,</span><span class="pln"> </span><span class="lit">3</span><span class="pun">,</span><span class="pln"> </span><span class="lit">2</span><span class="pun">])</span><span class="pln"><br><br></span><span class="com"># `a` * `b`</span><span class="pln"><br></span><span class="com"># [[[ 94, 100],</span><span class="pln"><br></span><span class="com"># &nbsp; [229, 244]],</span><span class="pln"><br></span><span class="com"># &nbsp;[[508, 532],</span><span class="pln"><br></span><span class="com"># &nbsp; [697, 730]]]</span><span class="pln"><br>c </span><span class="pun">=</span><span class="pln"> tf</span><span class="pun">.</span><span class="pln">matmul</span><span class="pun">(</span><span class="pln">a</span><span class="pun">,</span><span class="pln"> b</span><span class="pun">)</span><span class="pln"><br><br></span><span class="com"># Since python &gt;= 3.5 the @ operator is supported (see PEP 465).</span><span class="pln"><br></span><span class="com"># In TensorFlow, it simply calls the `tf.matmul()` function, so the</span><span class="pln"><br></span><span class="com"># following lines are equivalent:</span><span class="pln"><br>d </span><span class="pun">=</span><span class="pln"> a </span><span class="pun">@</span><span class="pln"> b </span><span class="pun">@</span><span class="pln"> </span><span class="pun">[[</span><span class="lit">10.</span><span class="pun">],</span><span class="pln"> </span><span class="pun">[</span><span class="lit">11.</span><span class="pun">]]</span><span class="pln"><br>d </span><span class="pun">=</span><span class="pln"> tf</span><span class="pun">.</span><span class="pln">matmul</span><span class="pun">(</span><span class="pln">tf</span><span class="pun">.</span><span class="pln">matmul</span><span class="pun">(</span><span class="pln">a</span><span class="pun">,</span><span class="pln"> b</span><span class="pun">),</span><span class="pln"> </span><span class="pun">[[</span><span class="lit">10.</span><span class="pun">],</span><span class="pln"> </span><span class="pun">[</span><span class="lit">11.</span><span class="pun">]])</span><span class="pln"><br></span></code></pre><div class="devsite-code-buttons-container"><button class="gc-analytics-event material-icons devsite-icon-code-dark devsite-toggle-dark" data-category="Site-Wide Custom Events" data-label="Dark Code Toggle" track-type="exampleCode" track-name="darkCodeToggle" data-title="Dark code theme"></button><button class="gc-analytics-event material-icons devsite-icon-code-light devsite-toggle-light" data-category="Site-Wide Custom Events" data-label="Light Code Toggle" track-type="exampleCode" track-name="lightCodeToggle" data-title="Light code theme"></button><button class="gc-analytics-event material-icons devsite-icon-copy" data-category="Site-Wide Custom Events" data-label="Click To Copy" track-type="exampleCode" track-name="clickToCopy" data-title="Copy"></button></div></devsite-code>
"""
